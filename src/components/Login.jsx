...
const Login = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -100 }}
      ...
      exit={{ opacity: 0, y: 0 }}
      transition={{ duration: 0.2 }} className="bg-gray-800/40 flex justify-center items-center fixed z-50 w-full h-screen pointer-events-auto overflow-hidden">
      <div className="w-[400px] h-auto bg-gray-900 text-black rounded-2xl p-10 flex flex-col relative gap-5">
